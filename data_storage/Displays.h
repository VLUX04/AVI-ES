...
string ChosedAirline; ///< Chosen airline code to filter during display operations.
set<string> airpotsToFilter; ///< Set of airports to filter during display operations.

/**
 * @brief Displays the number of airlines in the dataset.
 */
void numberAirlines(){
...
/**
 * @brief Filters the chosen airline for the output.
 * @param ChosedAirline_ The chosen airline to include in the output.
 */
