...
Airline::Airline(std::string airlineCode, std::string airlineName, std::string callSign, std::string country) {airlineCode_=airlineCode; airlineName_=airlineName; callSign_=callSign;}
